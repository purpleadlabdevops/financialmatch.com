    ...
    <div class="container">
      ...
      <div class="banner--box">
        ...
        <h1
          ...
          data-delay="1000"
          v-if="winWidth > 991">
          Has your business been impacted by the restrictions and impacts of COVID-19?
        </h1>
        ...
        <h4
          ...
          data-anim="fadeInUp"
          data-delay="1000">
          Our professionals do all the hard work so you can sleep at night knowing it was done right
        </h4>
