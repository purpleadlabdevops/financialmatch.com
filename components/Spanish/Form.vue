<template>
  <form @submit.prevent="submit" class="form">
    ...
    <div class="step" v-if="step === quiz.length && !notQualify">
      <h2>A continuación, ingrese su información para obtener sus resultados.</h2>
      <input
        type="text"
      ...
      <input
        ...
        id="phone"
      />
      <input type="submit" value="Enviar" :disabled="spinner" />
    ...
    <div class="step" v-if="notQualify">
      <h2>No califica para ERC</h2>
      <p>Desafortunadamente, según sus respuestas, parece que no podemos ayudarlo en este momento.</p>
    </div>
...
export default {
  data() {
    return {
      ...
      quiz: [
        {
          question: 'Tuve empleados W2 en 2020 o 2021 Sí/No',
          options: ['Sí', 'No'],
          answer: null,
          id: 'paid_w2_wages_20_21',
        },
        {
          question: '¿Cuántos empleados W2 tiene?',
          options: 'Number',
          min: 1,
          max: 100,
          answer: null,
        ...
        {
          question: '¿Tuvo alguna interrupción en la cadena de suministro en 2020 o 2021?',
          options: ['Sí', 'No'],
          answer: null,
          id: 'data4',
        },
        {
          question: '¿Tuvo una disminución en sus ingresos en 2020 o 2021 en comparación con 2019?',
          options: ['Sí', 'No'],
          answer: null,
          id: 'data5',
        },
        {
          question: '¿Recibió dinero del Programa de protección de nómina (PPP)?',
          options: ['Sí', 'No'],
          answer: null,
          id: 'pppMoney',
        }
  ...
  methods: {
    ...
    setUrl(object){
      const api = process.env.NODE_ENV === 'production' ? `https://go.financialmatch.com` : `http://${process.env.API}`
