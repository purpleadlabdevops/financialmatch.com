<template>
  <div class="congrat">
    <h1 class="congrat__title">
      Congratulations! <br />
      Based on your answers, you could qualify for <span v-if="money" style="filter: blur(9px);">{{ money }}</span>
    </h1>
    <svg
      width="102"
      height="109"
